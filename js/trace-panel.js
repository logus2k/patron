...
(function (global) {
  ...
  function ensurePanel() {
    ...
    panel = jsPanel.create({
      ...
      onclosed: function () { panel = null; body = null; if (global.PatronApp && global.PatronApp.menuBar) { global.PatronApp.menuBar.setContext("traceVisible", false); global.PatronApp.menuBar.refresh(); } if (global.PatronDebug) global.PatronDebug.onPanelClose(); },
      callback: function (p) {
