...
window.PATRON_MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Center Diagram", command: "view.center" },
      { label: "Fit to Selection", command: "view.fitSelection" },
      { label: "Reset Zoom", command: "view.resetZoom" },
      { label: "Zoom In", command: "view.zoomIn" },
      { label: "Zoom Out", command: "view.zoomOut" },
      { type: "separator" },
      { label: "Auto-arrange", command: "view.arrange" },
      { label: "Find Node…", command: "view.find" },
      { label: "Add Group", command: "view.addGroup" },
      { label: "Align Selected", submenu: [
        { label: "Left", command: "view.alignLeft" },
        { label: "Right", command: "view.alignRight" },
        { label: "Top", command: "view.alignTop" },
        { label: "Bottom", command: "view.alignBottom" },
      ] },
      { type: "separator" },
      { label: "Lock Canvas", command: "view.lock", type: "checkbox", checked: "canvasLocked" },
      { label: "Snap to Grid", command: "view.snap", type: "checkbox", checked: "snapGrid" },
      { label: "Curved Links", command: "view.curved", type: "checkbox", checked: "curvedLinks" },
      { label: "Link Arrows", command: "view.arrows", type: "checkbox", checked: "linkArrows" },
      { type: "separator" },
